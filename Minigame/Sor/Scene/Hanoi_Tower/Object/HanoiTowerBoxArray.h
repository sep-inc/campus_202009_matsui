#ifndef HANOITOWER_BOXARRAY_H_
#define HANOITOWER_BOXARRAY_H_
#include "HanoiTowerBox.h"
#include "../../../Utility/Vec2.h"

class HanoiTowerBoxArray
{
public:
    HanoiTowerBoxArray() :m_end(false) {}
    ~HanoiTowerBoxArray() {}
    ...
    bool SearchSorceDiskSize(unsigned __int8 disk_width, unsigned __int8 now_number_);

    bool SearchNextDiskSize(unsigned __int8 disk_width, unsigned __int8 next_number_);

    void SetUpDisk(Vec2 pos, unsigned  __int8 width_, unsigned  __int8 height_);      //diskを調査用box座標にセット
