...
//!コンストラクタ
PacManPlayer::PacManPlayer(PacManStage* stage_, PacManItem* item_, PACMAN_OBJECT_TYPE player_type_, const char* m_font_) :
...
{
	//PacManDrawer::Instance()->SetUpBuffer(m_pos, m_draw_font);
