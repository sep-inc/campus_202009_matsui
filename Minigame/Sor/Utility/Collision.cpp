...
//!辺と辺の当たり判定
bool Collision::EdgeCollision(Vec2 player_pos_, Vec2 rect_pos_, __int8 player_height_, __int8 player_width_, __int8 rect_height_, __int8 rect_width_, EdgeType type)
{
	//!選んだ辺の当たり判定を行う
	switch (type)
	{
