...
{
public:
	Ball() :m_step(STEP::STEP_INIT), m_move_step(STEP_HIT), m_hit_step(STEP_WALL), m_direction_vec(Vec2(1.0f, 1.0f)), m_next_pos(Vec2(0.0f, 0.0f)),m_delete_pos(Vec2(0.0f, 0.0f)) {}
	~Ball() {}
	...
	void HitBlockUnit(float y_);  //Block単体との当たり判定
